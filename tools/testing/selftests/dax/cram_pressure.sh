...
#
# CRAM read-only anonymous-memory pressure / livelock test.
#
# Hammers CRAM with simultaneous placement pressure and promotion
...
# on-write check catches an in-place write leak; the dmesg scan below catches
# kernel assertions and other splats.
#

 ...
 *
 * Also samples pgpromote_fence in the cram node vmstat: D1/D2/D5 must NOT grow it
...
/*
 * Each loop re-demotes the whole region, which is a real migration now that
 * MADV_PAGEOUT no longer reaches the tier -- 200 of them overran even the
 * 600s in settings.  40 still exercises repeated demote/drop cycling.
 */
#define CHURN_LOOPS 40
#define WRITERS 4
#define READERS 4

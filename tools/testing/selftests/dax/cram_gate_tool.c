 ...
 * reported critical pressure (cram_set_no_alloc(true)), cram_pick_node()
 * refuses and the pages spill to swap instead.
 *
 * Usage: cram_gate_tool <cram_nid>
 * Output: "oncram=<pages> total=<pages>"

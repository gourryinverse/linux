 ...
 * did not opt into NODE_PRIVATE_CAP_LTPIN must fail the pin AND stay in place (it
 ...
 *   bind        MPOL_BIND (relative nodemask)
 *   bindstatic  MPOL_BIND | MPOL_F_STATIC_NODES
...
int main(int argc, char **argv)
{
	...
	fprintf(stderr,
		...
		"       mbindhold <none|bind|bindstatic> <nid> <MB> <hold_s> |\n"
